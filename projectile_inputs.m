function [ v_0,theta,t ] = projectile_inputs 
...
v_0 = input('Please input the initial velocity in [m/s]:\n');
theta = input('Please input the angle of departure in [deg]:\n');
t = input('Please input the instataneous time in [s]:\n');

while v_0 < 0 || theta < 0 || t < 0
    v_0 = input('Please reinput the non-negative initial velocity in [m/s]:\n');
